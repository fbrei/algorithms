...
static sfmt_t state;
static const double OBST_RADIUS = sqrt( (10000 * 0.2261946710584651104) / (RANDOM_OBST * M_PI) );
...
int main() {
  ...
  fprintf(stderr, "Obstacle radius: %g\n", OBST_RADIUS);

  sfmt_init_gen_rand(&state,4346);
